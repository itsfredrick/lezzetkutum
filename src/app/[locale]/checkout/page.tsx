...
export default function CheckoutPage() {
    ...
    const shipping = 0;
    const discount = 0; // Keeping it simple for now, or use logic from Step 1
    ...
    const handleCheckout = () => {
        ...
        setTimeout(() => {
            ...
            resetFunnel(); // Clear store on success
                                ...
                                {menuSelection.map(item => {
                                    ...
                                    return (
                                        <div key={item.id} className="flex gap-3 py-3 border-b border-neutral-100">
                                            ...
                                            <div className="font-bold text-sm">{(recipe.price * item.quantity).toFixed(2)} TL</div>
                                        </div>
                                    );
                                })}
                            </div>
...
// Helper icons
function Info(props: any) { return <span {...props}>ⓘ</span> }
