...
const SIDEBAR_ITEMS = [
    ...
    { label: "Sıradaki Kutu", href: "/hesabim/sonraki-kutu", icon: Package },
    { label: "Geçmiş Siparişler", href: "/hesabim/siparislerim", icon: User }, // Icon mismatch in logic, fixing: History is Clock usually, but user design has 'Siparişlerim' as bag.
    { label: "Abonelik Ayarları", href: "/hesabim/abonelik", icon: Settings },
    { label: "Teslimat Adresleri", href: "/hesabim/adreslerim", icon: MapPin },
    { label: "Ödeme Yöntemleri", href: "/hesabim/odeme-yontemleri", icon: CreditCard },
    { label: "Lezzet Kredileri", href: "/hesabim/kredilerim", icon: CreditCard },
];
